...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.comment'
        db.add_column(u'issues_report', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Report.category'
        db.add_column(u'issues_report', 'category',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.comment'
        db.delete_column(u'issues_report', 'comment')

        # Deleting field 'Report.category'
        db.delete_column(u'issues_report', 'category')
    ...
    models = {
        ...
        u'issues.report': {
            ...
            'category': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '40', 'blank': 'True'}),
            'columns': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '5000', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
