...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.creator'
        db.add_column(u'issues_report', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reports', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Report.created'
        db.add_column(u'issues_report', 'created',
        ...
        db.add_column(u'issues_report', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 7, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.creator'
        db.delete_column(u'issues_report', 'creator_id')

        # Deleting field 'Report.created'
        db.delete_column(u'issues_report', 'created')

        # Deleting field 'Report.updated'
        db.delete_column(u'issues_report', 'updated')
    ...
    models = {
        ...
        u'issues.issue': {
            ...
            'priority_code': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'issues'", 'null': 'True', 'to': u"orm['issues.Priority']"}),
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'issues'", 'null': 'True', 'to': u"orm['issues.Status']"}),
        ...
        u'issues.priority': {
            'Meta': {'ordering': "('priority',)", 'object_name': 'Priority'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '35', 'blank': 'True'}),
        ...
        u'issues.report': {
            'Meta': {'ordering': "('order', 'name')", 'object_name': 'Report'},
            'columns': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '5000', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reports'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'filters': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '5000', 'blank': 'True'}),
            'group_by': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '5000', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sort_by': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '5000', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'issues.status': {
            'Meta': {'ordering': "('status',)", 'object_name': 'Status'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
