...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.name'
        db.alter_column(u'issues_issue', 'name', self.gf('django.db.models.fields.CharField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'Issue.name'
        db.alter_column(u'issues_issue', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))
