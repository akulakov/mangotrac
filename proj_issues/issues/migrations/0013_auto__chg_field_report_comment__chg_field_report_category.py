...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.comment'
        db.alter_column(u'issues_report', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Report.category'
        db.alter_column(u'issues_report', 'category', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'Report.comment'
        db.alter_column(u'issues_report', 'comment', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Report.category'
        db.alter_column(u'issues_report', 'category', self.gf('django.db.models.fields.TextField')(max_length=40))
    ...
    models = {
        ...
        u'issues.report': {
            'Meta': {'ordering': "('category', 'order', 'name')", 'object_name': 'Report'},
            'category': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '40', 'blank': 'True'}),
