...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'issues_priority', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=35)),
        ))
        db.send_create_signal(u'issues', ['Priority'])

        # Deleting field 'Issue.priority'
        db.delete_column(u'issues_issue', 'priority')

        # Adding field 'Issue.priority_code'
        db.add_column(u'issues_issue', 'priority_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='issues', null=True, to=orm['issues.Priority']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Priority'
        db.delete_table(u'issues_priority')
        ...
        # Deleting field 'Issue.priority_code'
        db.delete_column(u'issues_issue', 'priority_code_id')
